...
const StartScreen: React.FC<StartScreenProps> = ({ testInfo, onStart,isPreview=false }) => {
    ...
    const totalTimeInMinutes = testInfo.sections.reduce((acc, section) => acc + (section.timeLimit || 0), 0);
                        ...
                        isPreview ? (
                            <div className="space-y-6">
                                <div className="mb-6 p-4 bg-blue-50 rounded-md">
                                    <h3 className="text-lg font-medium text-blue-800 mb-2">Test Preview Mode</h3>
                                    <p className="text-sm text-blue-700 mb-2">{testInfo.description}</p>
                                    <p className="text-sm text-blue-700">
                                        <strong>Duration:</strong> {Math.floor(totalTimeInMinutes / 60)}h {totalTimeInMinutes % 60}m minutes</p>
                                </div>
                                <button
                                    onClick={() =>
                                        onStart({
                        ...
                        <>
                            <div className="mb-6 p-4 bg-blue-50 rounded-md">
                                ...
                                <div className="text-sm text-blue-700">
                                    <p><strong>Duration:</strong> {Math.floor(totalTimeInMinutes / 60)}h {totalTimeInMinutes % 60}m minutes</p>
