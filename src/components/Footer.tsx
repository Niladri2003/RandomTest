      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Create, share, and evaluate tests with ease. Perfect for educators and employers.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-400">
                ...
                <span>support@testcraft.com</span>
              </li>
              <li className="flex items-center text-gray-400">
              ...
              <li className="flex items-center text-gray-400">
                ...
                <span>123 Test Ave, Education City</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} TestCraft. All rights reserved.
          </p>
